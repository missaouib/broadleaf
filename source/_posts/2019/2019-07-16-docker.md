...
category: devops
tags: [docker]
description:  Docker 最初是 dotCloud 公司创始人 Solomon Hykes 在法国期间发起的一个公司内部项目，它是基于 dotCloud 公司多年云服务技术的一次革新，并于 2013 年 3 月以 Apache 2.0 授权协议开源，主要项目代码在 GitHub 上进行维护。Docker 项目后来还加入了 Linux 基金会，并成立推动 开放容器联盟（OCI）。
---
...
3、Registry和Repositories

- Registry是存储docker镜像的地方
- 可自建私有Registry和使用共用Registry如Docker Hub
- 在Registry中，镜像存储在Repositories
- Repositories是具有相同名字、不同标签的镜像集合
...
![img](/images/620140640_31678.png)
...
![img](/images/262150629_86976.png)
...
主要是修改/etc/docker/daemon.json文件。
...
- [什么是 Docker](https://www.funtl.com/zh/docker/)
